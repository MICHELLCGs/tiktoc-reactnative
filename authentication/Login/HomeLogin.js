    ...
    <View style={styles.safe}>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.tituloconte} >
                <Text style={styles.prueba}>Inicia sesión en Tiktoc</Text>
            </View>
            ...
            <View style={styles.bottomButtonContainer}>
                <TouchableOpacity style={styles.Registro_boton} onPress={() => navigation.navigate('HomeRegister')}>
                    <Text style={styles.registerText}>¿No tienes una cuenta?</Text>
                    <Text style={[styles.registerText,{color:'#FF4500'}]}>Registrarse</Text>
                </TouchableOpacity>
            </View>
